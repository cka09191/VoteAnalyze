package VoteAnalyze::Admin::ViewFunctions;
use strict;
use warnings;
use utf8;
...
sub c { VoteAnalyze->context() }
sub uri_with { VoteAnalyze->context()->req->uri_with(@_) }
sub uri_for { VoteAnalyze->context()->uri_for(@_) }
